// PRISM conformance task kindmem/kindmem_memcpy_uninit_false.c: expected false (memsafety)
...
#include <string.h>
int kindmem_memcpy_uninit_false(int n) {
    int src[4];
    int dst[4] = {0, 0, 0, 0};
    src[0] = 1;
    ...
    return dst[1]; /* copied from an uninitialised element */
}
