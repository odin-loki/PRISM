...
*Category: [Null pointer dereference](/docs/all-categories#null-pointer-dereference). Reported as "Block Parameter Not Null Checked" by [parameter-not-null-checked](/docs/checker-parameter-not-null-checked).*
...
*Category: [User defined property](/docs/all-categories#user-defined-property). Reported as "Annotation Reachability Error" by [annotation-reachability](/docs/checker-annotation-reachability).*
...
*Category: [Perf regression](/docs/all-categories#perf-regression). Reported as "Expensive Method Called" by [annotation-reachability](/docs/checker-annotation-reachability).*
...
*Category: [Null pointer dereference](/docs/all-categories#null-pointer-dereference). Reported as "Compared To Null And Dereferenced" by [pulse](/docs/checker-pulse).*
...
*Reported as "Config Gated" by [config-gating](/docs/checker-config-gating).*
...
*Reported as "Config Ungated" by [config-gating](/docs/checker-config-gating).*
...
*Category: [Memory error](/docs/all-categories#memory-error). Reported as "C++ String Captured in Block" by [self-in-block](/docs/checker-self-in-block).*
...
*Category: [Runtime exception](/docs/all-categories#runtime-exception). Reported as "Infinite Loop" by [pulse](/docs/checker-pulse).*
...
*Category: [Runtime exception](/docs/all-categories#runtime-exception). Reported as "Infinite Recursion" by [pulse](/docs/checker-pulse).*
...
*Category: [Sensitive data flow](/docs/all-categories#sensitive-data-flow). Reported as "Lineage Flow" by [lineage](/docs/checker-lineage).*
...
*Category: [Perf regression](/docs/all-categories#perf-regression). Reported as "Lock on UI Thread" by [starvation](/docs/checker-starvation).*
...
*Category: [Memory error](/docs/all-categories#memory-error). Reported as "NSString Captured in Block" by [self-in-block](/docs/checker-self-in-block).*
...
*Category: [Runtime exception](/docs/all-categories#runtime-exception). Reported as "Assertion Error" by [pulse](/docs/checker-pulse).*

This error is reported in Java and in Python. It fires when we detect a path that leads to an assertion failure.
...
*Category: [Resource leak](/docs/all-categories#resource-leak). Reported as "Unfinished Builder" by [pulse](/docs/checker-pulse).*
...
*Category: [Runtime exception](/docs/all-categories#runtime-exception). Reported as "Uninitialized Method" by [pulse](/docs/checker-pulse).*
...
*Category: [Perf regression](/docs/all-categories#perf-regression). Reported as "Unnecessary Copy Assignment into Thrift" by [pulse](/docs/checker-pulse).*
...
*Category: [Resource leak](/docs/all-categories#resource-leak). Reported as "Self In Block Passed To Init" by [self-in-block](/docs/checker-self-in-block).*
...
*Category: [Concurrency](/docs/all-categories#concurrency). Reported as "Static Constructor Stall" by [static-constructor-stall-checker](/docs/checker-static-constructor-stall-checker).*
...
*Category: [Memory error](/docs/all-categories#memory-error). Reported as "Static Initialization Order Fiasco" by [siof](/docs/checker-siof).*
...
*Category: [User defined property](/docs/all-categories#user-defined-property). Reported as "Topl Error" by [topl](/docs/checker-topl).*
...
*Category: [User defined property](/docs/all-categories#user-defined-property). Reported as "Topl Error Latent" by [topl](/docs/checker-topl).*
