...
- [STATIC_CONSTRUCTOR_STALL](/docs/all-issue-types#static_constructor_stall)
...
- [COMPARED_TO_NULL_AND_DEREFERENCED](/docs/all-issue-types#compared_to_null_and_dereferenced)
...
- [LOCK_ON_UI_THREAD](/docs/all-issue-types#lock_on_ui_thread)
...
- [PULSE_UNNECESSARY_COPY_THRIFT_ASSIGNMENT](/docs/all-issue-types#pulse_unnecessary_copy_thrift_assignment)
...
- [PULSE_UNFINISHED_BUILDER](/docs/all-issue-types#pulse_unfinished_builder)
...
- [INFINITE_LOOP](/docs/all-issue-types#infinite_loop)
- [INFINITE_RECURSION](/docs/all-issue-types#infinite_recursion)
...
- [PULSE_ASSERTION_ERROR](/docs/all-issue-types#pulse_assertion_error)
...
- [PULSE_UNINITIALIZED_METHOD](/docs/all-issue-types#pulse_uninitialized_method)
