...
Dots in an if branch that ends with a return are allowed to flow over any
goto encountered in the if branch.  Intuitively, if branches that end in
return are handling errors, and the error handling code may appear
immediately or at the end of the function.
