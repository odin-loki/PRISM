...
constexpr std::array<std::string_view, 29> kStages{
...
constexpr std::array<Origin, 29> kStageOrigin{
    ...
    Origin::Solver, Origin::Solver, Origin::Solver, Origin::Solver,  // contracts wp bmc harness
...
const std::array<std::string_view, 29>& audit_stages() { return kStages; }
